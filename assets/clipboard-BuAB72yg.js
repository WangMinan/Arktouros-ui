import { g as $, h as B } from "./dayjs-DuEr9S7h.js";
var R = { exports: {} };
/*!
    ...
    return function() {
      var L = { 686: function(l, c, t) {
        ...
        var j = function() {
          ...
          if (u !== void 0) if (u && x(u) === "object" && u.nodeType === 1) {
        ...
        function _(i) {
          "@babel/helpers - typeof";
          return typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? _ = function(e) {
            return typeof e;
          } : _ = function(e) {
            return e && typeof Symbol == "function" && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e;
          }, _(i);
        ...
        function I(i, n) {
          ...
          i.prototype = Object.create(n && n.prototype, { constructor: { value: i, writable: true, configurable: true } }), n && C(i, n);
        }
        function C(i, n) {
        ...
        var V = function(i) {
          ...
          return H(e, [{ key: "resolveOptions", value: function() {
            ...
            this.action = typeof o.action == "function" ? o.action : this.defaultAction, this.target = typeof o.target == "function" ? o.target : this.defaultTarget, this.text = typeof o.text == "function" ? o.text : this.defaultText, this.container = _(o.container) === "object" ? o.container : document.body;
            ...
            var u = o.delegateTarget || o.currentTarget, m = this.action(u) || "copy", w = D({ action: m, container: this.container, target: this.target(u), text: this.text(u) });
            this.emit(w ? "success" : "error", { action: m, text: w, trigger: u, clearSelection: function() {
      ...
      function b(l) {
        ...
        var c = S[l] = { exports: {} };
        return L[l](c, c.exports, b), c.exports;
      }
      return function() {
        b.n = function(l) {
        ...
        b.d = function(l, c) {
          for (var t in c) b.o(c, t) && !b.o(l, t) && Object.defineProperty(l, t, { enumerable: true, get: c[t] });
        };
      }(), function() {
        b.o = function(l, c) {
