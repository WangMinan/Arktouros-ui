...
function q(r, e, t) {
  let n, s, a;
  if (r = u(r, 360), e = u(e, 100), t = u(t, 100), e === 0) s = t, a = t, n = t;
  else {
...
class f {
  ...
  toName() {
    ...
    for (const [t, n] of Object.entries(y)) if (e === n) return t;
    return false;
  }
  toString(e) {
    const t = !!e;
  ...
  analogous(e = 6, t = 30) {
    ...
    for (n.h = (n.h - (s * e >> 1) + 720) % 360; --e; ) n.h = (n.h + s) % 360, a.push(new f(n));
    return a;
  }
  complement() {
    const e = this.toHsl();
  ...
  monochromatic(e = 6) {
    ...
    let { v: a } = t;
    const i = [], h = 1 / e;
    for (; e--; ) i.push(new f({ h: n, s, v: a })), a = (a + h) % 1;
    return i;
  }
  splitcomplement() {
  ...
  polyad(e) {
    ...
    for (let i = 1; i < e; i++) s.push(new f({ h: (n + i * a) % 360, s: t.s, l: t.l }));
    return s;
  }
  equals(e) {
    const t = new f(e);
